...
const kahfLogo = new URL('@/assets/img/logokahf.png', import.meta.url).href
const chaviLogo = new URL('@/assets/img/logochavi.png', import.meta.url).href
const aboutUs = new URL('@/assets/img/aboutus.jpg', import.meta.url).href
const visiMisi = new URL('@/assets/img/visimisi.jpg', import.meta.url).href
        ...
        <div data-aos="fade-up" class="p-4 md:w-1/3">
          <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
            <div class="flex items-center mb-3">
              ...
              >
                <img :src="kratingDaeng" alt="Kratingdaeng" />
              </div>
          ...
          <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
            <div class="flex items-center mb-3">
              <div
                class="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-white text-white flex-shrink-0"
              >
                <img :src="chaviLogo" alt="Chavi Helmets" />
              </div>
      ...
      <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left">
        <div class="flex flex-col mb-10">
          <div class="font-light text-gray-500 sm:text-lg dark:text-white">
            <h2 class="text-3xl font-mabolistafont leading-8 text-gray-900 dark:text-white">
              About Us
            </h2>
            ...
            <a href="/contact" class="mt-3 text-slate-300 inline-flex items-center"
              >Info Kerjasama
              <svg
                fill="none"
                stroke="currentColor"
      ...
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            />
            <div class="flex-grow">
              <h2 class="text-gray-900 dark:text-white title-font font-medium">Hilal (Balong)</h2>
        ...
        <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
          ...
          >
            ...
            />
            <div class="flex-grow">
              <h2 class="text-gray-900 dark:text-white title-font font-medium">Ilham</h2>
  ...
  <section class="text-gray-700 body-font border-t border-gray-200">
    <div class="container px-5 py-24 mx-auto">
      <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
        ...
        <h2 class="text-gray-900 dark:text-white font-medium title-font tracking-wider text-sm">
          Mabolista Fc
        </h2>
        <p class="text-gray-500 dark:text-white">Football Community</p>
      </div>
    </div>
  </section>
