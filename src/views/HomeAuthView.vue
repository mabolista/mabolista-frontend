      ...
      <div class="flex justify-between">
        ...
        <div class="hidden md:flex items-center space-x-1">
          ...
          <button
            ...
            class="flex mx-3 my-2 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            type="button"
          >
          ...
          >
            <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
              <div>Mabolista</div>
              <div class="font-medium truncate">mabolista@gmail.com</div>
            </div>
            <ul
  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-center text-3xl font-mabolistafont leading-8">Benefits</h2>
