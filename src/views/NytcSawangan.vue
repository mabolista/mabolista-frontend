  ...
  <section class="bg-white py-4">
    <div class="container py-8 px-6 mx-auto">
      ...
      <p class="mt-2 mb-8">
        ...
        KABARIN DI GRUP H-3 BUAT CANCEL SUPAYA GAMPANG CARI ORANG PENGGANTINYA, JIKA SUDAH LIST DAN
        TIDAK DATANG, WAJIB TF JIKA ENGGAK ADA PENGGANTINYA..DAN TETAP JAGA PROKES
      </p>
    </div>
  </section>
  <!-- Main modal -->
