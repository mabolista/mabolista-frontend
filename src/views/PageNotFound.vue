<template>
  ...
  >
    <div class="container">
      <div class="row">
        <div class="col-sm-8 offset-sm-2 text-white text-center -mt-52">
          <div class="relative">
          ...
          <h5 class="text-white font-semibold -mr-10 -mt-3">Page not found</h5>
          <p class="text-white mt-2 mb-6">we are sorry, but the page you requested was not found</p>
          <a
            href="/"
